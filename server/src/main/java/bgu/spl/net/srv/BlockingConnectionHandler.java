...
public class BlockingConnectionHandler<T> implements Runnable, ConnectionHandler<T> {
    ...
    public void send(T msg) {
        //IMPLEMENT IF NEEDED
        try{ // we use try catch because we need to catch the exception that might be thrown by the write function
            if (msg!=null){
                out.write(encdec.encode(msg)); // we write the encoded message to the output stream
                out.flush();
            }
